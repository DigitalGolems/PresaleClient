...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      instanceDBT.options.address = "" //set  DBT Presale address
      instanceDIG.options.address = "" //set DIG Presale address
      dig.options.address = ""  //set DIG address
      ...
      let flag = false;
      let newSign = {}
      //see if user have sign from owner
      SignsDBT.map(
        (value) => {
